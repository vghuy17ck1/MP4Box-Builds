...
data = {
    ...
    "variant": variant,
    "linkage_mode": "shared" if variant.startswith("shared-") else "static",
    ...
    "dependency_versions": {"zlib": metadata.get("zlib_requested_ref", metadata.get("zlib_ref", ""))},
    "zlib_requested_ref": metadata.get("zlib_requested_ref", ""),
    "zlib_resolved_ref": metadata.get("zlib_resolved_ref", metadata.get("zlib_ref", "")),
    ...
    "static_verification": static_status == "true" and not variant.startswith("shared-"),
    "linkage_verification": static_status == "true",
